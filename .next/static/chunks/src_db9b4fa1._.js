...
var { g: global, __dirname, k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
// Data models for Annpurna Traders business management app
__turbopack_context__.s({
...
var { g: global, __dirname, k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
// Local storage helper functions for Annpurna Traders app
__turbopack_context__.s({
...
;
const STORAGE_KEYS = {
    CUSTOMERS: 'annpurna_customers',
    PRODUCTS: 'annpurna_products',
    ORDERS: 'annpurna_orders',
    PAYMENTS: 'annpurna_payments',
    TRANSACTIONS: 'annpurna_transactions',
    NOTIFICATIONS: 'annpurna_notifications',
    STOCK_MOVEMENTS: 'annpurna_stock_movements',
    INITIALIZED: 'annpurna_initialized'
};
// Generate unique ID
function generateId() {
...
function deleteItem(key, id) {
    try {
        ...
        throw new Error(`Failed to delete item from ${key}`);
    }
}
...
const db = {
    // Customers
    customers: {
        getAll: ()=>getData(STORAGE_KEYS.CUSTOMERS),
        add: (customer)=>addItem(STORAGE_KEYS.CUSTOMERS, customer),
        update: (id, updates)=>updateItem(STORAGE_KEYS.CUSTOMERS, id, updates),
        delete: (id)=>deleteItem(STORAGE_KEYS.CUSTOMERS, id),
        getById: (id)=>getItemById(STORAGE_KEYS.CUSTOMERS, id)
    },
    // Products
    products: {
        getAll: ()=>getData(STORAGE_KEYS.PRODUCTS),
        add: (product)=>addItem(STORAGE_KEYS.PRODUCTS, product),
        update: (id, updates)=>updateItem(STORAGE_KEYS.PRODUCTS, id, updates),
        delete: (id)=>deleteItem(STORAGE_KEYS.PRODUCTS, id),
        getById: (id)=>getItemById(STORAGE_KEYS.PRODUCTS, id),
        getLowStock: ()=>{
            const products = getData(STORAGE_KEYS.PRODUCTS);
            return products.filter((product)=>product.currentStock <= product.threshold);
        }
    },
    // Orders
    orders: {
        getAll: ()=>getData(STORAGE_KEYS.ORDERS),
        add: (order)=>addItem(STORAGE_KEYS.ORDERS, order),
        update: (id, updates)=>updateItem(STORAGE_KEYS.ORDERS, id, updates),
        delete: (id)=>deleteItem(STORAGE_KEYS.ORDERS, id),
        getById: (id)=>getItemById(STORAGE_KEYS.ORDERS, id),
    ...
    // Payments
    payments: {
        getAll: ()=>getData(STORAGE_KEYS.PAYMENTS),
        add: (payment)=>addItem(STORAGE_KEYS.PAYMENTS, payment),
        delete: (id)=>deleteItem(STORAGE_KEYS.PAYMENTS, id),
        getById: (id)=>getItemById(STORAGE_KEYS.PAYMENTS, id),
        getByCustomer: (customerId)=>{
    ...
    // Transactions
    transactions: {
        getAll: ()=>getData(STORAGE_KEYS.TRANSACTIONS),
        add: (transaction)=>addItem(STORAGE_KEYS.TRANSACTIONS, transaction),
        delete: (id)=>deleteItem(STORAGE_KEYS.TRANSACTIONS, id),
        getById: (id)=>getItemById(STORAGE_KEYS.TRANSACTIONS, id),
    ...
    notifications: {
        ...
        add: (notification)=>addItem(STORAGE_KEYS.NOTIFICATIONS, notification),
        update: (id, updates)=>updateItem(STORAGE_KEYS.NOTIFICATIONS, id, updates),
        delete: (id)=>deleteItem(STORAGE_KEYS.NOTIFICATIONS, id),
        getUnread: ()=>{
            const notifications = getData(STORAGE_KEYS.NOTIFICATIONS);
            return notifications.filter((notification)=>!notification.isRead);
        },
        markAsRead: (id)=>updateItem(STORAGE_KEYS.NOTIFICATIONS, id, {
                isRead: true
            })
    },
    // Stock Movements
    stockMovements: {
        getAll: ()=>getData(STORAGE_KEYS.STOCK_MOVEMENTS),
        add: (movement)=>addItem(STORAGE_KEYS.STOCK_MOVEMENTS, movement),
        getByProduct: (productId)=>{
            const movements = getData(STORAGE_KEYS.STOCK_MOVEMENTS);
...
function initializeDefaultData() {
    try {
        ...
        const existingProducts = getData(STORAGE_KEYS.PRODUCTS);
        if (existingProducts.length === 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$models$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_PRODUCTS"].forEach((product)=>{
...
function ProductForm({ onSuccess }) {
    ...
    const [stockMovement, setStockMovement] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        type: 'incoming',
        quantity: '',
        reason: ''
    });
    ...
    const loadProducts = ()=>{
        try {
            const productData = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].products.getAll();
    ...
    const validateStockMovement = ()=>{
        ...
        if (!stockMovement.quantity || isNaN(Number(stockMovement.quantity)) || Number(stockMovement.quantity) <= 0) {
            newErrors.quantity = 'Please enter a valid quantity';
        }
        if (!stockMovement.reason.trim()) {
            newErrors.reason = 'Please enter a reason for stock movement';
        }
        // Check if outgoing quantity exceeds current stock
        if (stockMovement.type === 'outgoing' && selectedProductId) {
            const product = products.find((p)=>p.id === selectedProductId);
            if (product && Number(stockMovement.quantity) > product.currentStock) {
                newErrors.quantity = `Cannot remove ${stockMovement.quantity} items. Only ${product.currentStock} available.`;
            }
        }
        setErrors(newErrors);
    ...
    const validateNewProduct = ()=>{
        ...
        if (!newProduct.currentStock || isNaN(Number(newProduct.currentStock)) || Number(newProduct.currentStock) < 0) {
            newErrors.currentStock = 'Please enter a valid stock quantity';
        }
        if (!newProduct.threshold || isNaN(Number(newProduct.threshold)) || Number(newProduct.threshold) < 0) {
            newErrors.threshold = 'Please enter a valid threshold';
        }
        if (!newProduct.unit.trim()) {
            newErrors.unit = 'Unit is required';
        }
        if (!newProduct.pricePerUnit || isNaN(Number(newProduct.pricePerUnit)) || Number(newProduct.pricePerUnit) <= 0) {
    ...
    const handleStockMovement = async (e)=>{
        ...
        try {
            ...
            const newStock = stockMovement.type === 'incoming' ? product.currentStock + quantity : product.currentStock - quantity;
            // Update product stock
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].products.update(selectedProductId, {
                currentStock: newStock
            });
            // Record stock movement
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].stockMovements.add({
            ...
            setErrors({
                submit: 'Failed to update stock. Please try again.'
            });
        } finally{
    ...
    const handleAddProduct = async (e)=>{
        ...
        setIsSubmitting(true);
        try {
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].products.add({
                                ...
                                children: [
                                    ...
                                    selectedProduct && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            selectedProduct.currentStock <= selectedProduct.threshold && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Select"], {
                                                ...
                                                onValueChange: (value)=>setStockMovement((prev)=>({
                                                            ...prev,
                                                            type: value
                                                        })),
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectContent"], {
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectItem"], {
                                                                value: "outgoing",
                                                                children: "Outgoing Stock (Remove)"
                                                            }, void 0, false, {
                                                                fileName: "[project]/src/components/ProductForm.tsx",
                                                                lineNumber: 254,
                                                                columnNumber: 21
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Input"], {
                                                ...
                                                placeholder: "e.g., Purchase, Sale, Damage, Adjustment",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                        ...
                                        className: "w-full",
                                        children: isSubmitting ? 'Updating...' : 'Update Stock'
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/ProductForm.tsx",
                                        lineNumber: 290,
                                        columnNumber: 15
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    errors.currentStock && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        className: "text-sm text-red-500",
                                                        children: errors.currentStock
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/components/ProductForm.tsx",
                                                        lineNumber: 336,
                                                        columnNumber: 21
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    errors.threshold && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        className: "text-sm text-red-500",
                                                        children: errors.threshold
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/components/ProductForm.tsx",
                                                        lineNumber: 352,
                                                        columnNumber: 21
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    errors.pricePerUnit && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        className: "text-sm text-red-500",
...
_s(ProductForm, "M2agCS1MsoobrsKBiNYkFGM2CS0=");
_c = ProductForm;
var _c;
...
function ProductList({ refreshTrigger, onEditProduct }) {
    ...
    const loadData = ()=>{
        try {
            setIsLoading(true);
            const productData = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].products.getAll();
            const movementData = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].stockMovements.getAll();
            setProducts(productData);
    ...
    const getStockPercentage = (product)=>{
        // Calculate percentage based on threshold as 100%
        const maxStock = Math.max(product.threshold * 2, product.currentStock);
        return Math.min(product.currentStock / maxStock * 100, 100);
    };
    const getRecentMovements = (productId)=>{
        return stockMovements.filter((movement)=>movement.productId === productId).sort((a, b)=>new Date(b.date).getTime() - new Date(a.date).getTime()).slice(0, 5);
    };
    ...
    const lowStockProducts = products.filter((product)=>product.currentStock <= product.threshold && product.currentStock > 0);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            (lowStockProducts.length > 0 || outOfStockProducts.length > 0) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$alert$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Alert"], {
                variant: "destructive",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$alert$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AlertDescription"], {
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "space-y-1",
                        children: [
                            outOfStockProducts.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                children: [
                                    "⚠️ Out of stock: ",
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: products.filter((p)=>p.currentStock > p.threshold).length
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/ProductList.tsx",
                                            lineNumber: 129,
                                            columnNumber: 15
                                        ...
                                        children: [
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                        className: "font-semibold",
                                                                        children: formatCurrency(product.pricePerUnit)
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/src/components/ProductList.tsx",
                                                                        lineNumber: 190,
                                                                        columnNumber: 29
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                        className: "font-semibold",
                                                                        children: formatCurrency(product.currentStock * product.pricePerUnit)
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/src/components/ProductList.tsx",
                                                                        lineNumber: 194,
                                                                        columnNumber: 29
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    onEditProduct && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                        variant: "outline",
                                                        size: "sm",
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    ...
                                                    recentMovements.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        className: "text-sm text-gray-500",
                                                        children: "No recent movements"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/components/ProductList.tsx",
                                                        lineNumber: 240,
                                                        columnNumber: 29
                                                        ...
                                                        className: "space-y-2",
                                                        children: recentMovements.map((movement)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        ...
                                                                        children: [
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
                                                                                variant: movement.type === 'incoming' ? 'default' : 'secondary',
                                                                                children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                        ...
                                                                        children: formatDate(movement.date)
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/src/components/ProductList.tsx",
                                                                        lineNumber: 251,
                                                                        columnNumber: 35
...
_s(ProductList, "xIadfJGb/h9rKcNBR2ZlKuNHsC4=");
_c = ProductList;
var _c;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ProductList$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ProductList"], {
...
_s(InventoryPage, "r93pIib7xcEsQmDZVPOF5nTLOpY=");
_c = InventoryPage;
var _c;
...
//# sourceMappingURL=src_db9b4fa1._.js.map